...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  return _c('div', [_c('div', {
    ...
    staticClass: "text-left"
  }, [_vm._v("\n    3.为了更好地向您推荐、展示或推送可能感兴趣的信息，本应用可能会收集您操作、使用本应用软件必要的行为信息用于生成用户画像和个性化展示，包括但不限于：\n    发布、点击、浏览、反馈-等，以及您自己填写、标注的兴趣、喜好等。"), _c('b', [_vm._v("上述信息仅在您使用本产品期间会被使用。")])]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
  }, [_vm._v("\n    4.设备信息：我们会申请电话/设备权限，收集设备识别码相关信息，"), _c('b', [_vm._v("用于信息推送和安全风控；拒绝该权限，将影响推送的准确度和账户安全状态的提示。")])]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
  }, [_vm._v("\n    5.存储权限：当您使用万年历、阅读等功能时，我们需要申请存储权限，以通过写入本地缓存的方式存储应用的相关数据，"), _c('b', [_vm._v("以保证您的使用记录等信息不会丢失，并降低流量消耗；")])]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
  }, [_c('b', [_vm._v("6.读取本地相册及相机权限。当您设置、更换用户头像、添加照片需使用“拍照”功能时，我们会请求您授权相机或本地相册权限。如果您同时拒绝上述两个权限，将无法使用此功能。")])]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
  }, [_vm._v("\n    7.为保障您及时接收相关消息，我们会请求您授权"), _c('b', [_vm._v("通知权限")]), _vm._v("。如您拒绝提供，仅会使您无法使用该功能，但不影响您正常使用本软件的其他功能。\n  ")]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
  }, [_vm._v("\n    8.读取日历权限。当您需要展示系统日历的日程信息时，我们会请求您日历权限。如果您拒绝授权提供，将无法使用此功能。\n  ")]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
  }, [_vm._v("\n    9.为了正常接收节假日、日程、生日纪念日等重要提醒，您可以在手机系统设置中开启命理寻真关联启动，保证APP相关进程运行来推送提醒信息。"), _c('b', [_vm._v("\n      同时，由于本应用SDK技术由与我们合作的第三方机构提供，为保障消息触达的及时性，在您使用消息推送服务时，您可以授权我们进行链路调节，相互促活被关闭的SDK推送进程，从而保障推送消息的有效触达。上述内容您可详阅本政策第四条。\n    ")])]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
    ...
    staticClass: "text-left"
  }, [_vm._v("\n    11.如果您在本应用发生交易行为，则相关支付功能由我们合作的第三方机构向您提供，第三方机构可能需要收集您的姓名、银行卡类型、银行卡账号、银行卡有效期、银行卡绑定的手机号码。如果您拒绝提供支付必须信息，则您无法完成交易，从而无法使用对应的服务，但不会影响其他功能的正常使用。"), _c('b', [_vm._v("我们仅会从第三方机构处获取您的交易成功的结果验证信息并向您提供服务。在您注销账号时，本应用将停止使用并删除上述信息。")])]), _vm._v(" "), _c('p', [_c('b', [_c('span', {
    staticClass: "ml-32"
  }, [_vm._v(" 12.自启动和关联启动说明 ")]), _vm._v(" "), _c('br'), _vm._v(" "), _c('span', {
    staticClass: "ml-32"
    ...
    staticClass: "text-left"
  }, [_c('b', [_vm._v("2.更正您的个人信息，当您发现本应用处理的关于您的个人信息有错误时，您有权要求本应用做出更正。您还可以在登录后，点击“我的”-“用户头像”进入个人中心，在该页面您可修改您的头像、昵称、，点击“四柱八字”在“您的档案信息”条目中修改您的真实姓名、性别、生日、出生地。")])]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
    ...
    staticClass: "text-left"
  }, [_c('b', [_vm._v("个人信息保护/信息安全部门联系方式：developer@weli.cn ")])]), _vm._v(" "), _c('p', [_c('b', [_vm._v(" 十一、隐私政策有效期及更新时间 ")])]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
...
var _cn_privacy = __webpack_require__(1599);

var _cn_privacy2 = _interopRequireDefault(_cn_privacy);

var _tw_privacy = __webpack_require__(1600);
...
var _privacy = __webpack_require__(722);
 ...
 * @LastEditors: wujiang
 * @LastEditTime: 2024-01-04 10:53:56
 * @Description:
 */
...
new _vue2.default({
  ...
  template: '<App/>',
  components: { App: _privacy2.default }
});
