...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  return _c('div', [_c('div', {
    ...
    staticClass: "text-left"
  }, [_c('b', [_vm._v(" 欢迎您使用“求真咨询师”软件及服务！ ")])]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
  }, [_c('b', [_vm._v("\n      为使用求真咨询师软件（以下统称“本软件”）及服务，您应当阅读并遵守《用户协议》（以下简称“本协议”），以及\n      "), _c('a', {
    attrs: {
      "href": "https://psychicai-h5.psychicai.pro/ios_master_privacy.html?is_master=1"
    }
  }, [_vm._v("《隐私权政策》")]), _vm._v("。请您务必审慎阅读、充分理解各条款内容，特别是免除或者限制平台责任的条款、对用户权利进行限制的条款、约定争议解决方式和司法管辖的条款等，以及开通或使用某项服务的单独协议。限制、免责条款或者其他涉及您重大权益的条款可能以加粗、加下划线等形式提示您重点注意。\n    ")])]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
    ...
    staticClass: "text-left"
  }, [_c('b', [_vm._v("\n      求真咨询师用户：指注册、登录、使用求真咨询师软件及服务的个人、企业或其他组织。\n    ")])]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
  }, [_c('b', [_vm._v("\n      前述“求真咨询师用户”统称为“用户”或“所有用户”，在本协议中更多地称为“您”。\n    ")])]), _vm._v(" "), _c('p', [_c('b', [_vm._v(" 一、【协议的范围】 ")])]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
    ...
    staticClass: "text-left"
  }, [_vm._v("\n    2.1\n    本软件是指平台开发并按照本协议及平台其他协议、规则之约定授权用户下载、安装、使用的"), _c('b', [_vm._v("求真咨询师")]), _vm._v("软件。\n  ")]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
    ...
    staticClass: "text-left"
  }, [_vm._v("\n    7.4.1\n    您理解并同意：若您违反法律法规、本协议和/或平台其他协议、规则的，平台有权随时单方根据相应情形采取以下一项或多项措施（具体措施的时间长短由平台根据您的违法违约情节相应情况确定）："), _c('br'), _vm._v("\n    （1）对您进行警告。"), _c('br'), _vm._v("\n    （2）限制您使用本软件和/或本服务部分或全部功能。"), _c('br'), _vm._v("\n    （3）删除、屏蔽相关内容或断开链接。"), _c('br'), _vm._v("\n    （4）中止、终止您对相应中"), _c('b', [_vm._v("求真咨询师")]), _vm._v("账号的使用（简称“封号”）。"), _c('br'), _vm._v("\n    （5）采取其他合理、合法的措施。"), _c('br'), _vm._v("\n    （6）依法追究您的法律责任。\n  ")]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
  }, [_vm._v("\n    7.4.2\n    如果您违反法律法规、本协议和/或平台其他协议、规则，平台对您或您使用的本软件和/或本服务采取任何行为或措施后，导致您暂时或永久无法使用"), _c('b', [_vm._v("求真咨询师")]), _vm._v("、无法使用"), _c('b', [_vm._v("求真咨询师")]), _vm._v("登录或使用其他产品和/或服务，您应自行承担相应后果，由此造成您损失的，您应自行承担。\n  ")]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
    ...
    staticClass: "text-left"
  }, [_vm._v("\n    7.6.1\n    未经授权和许可，用户不得利用"), _c('b', [_vm._v("求真咨询师")]), _vm._v("上传、储存、共享、传播含有受到知识产权法律保护的图像、相片、视频、软件或其他数据资料、文件。用户违反相关知识产权保护法律、规范，侵害第三方合法权益的，均由用户自行承担责任，给平台造成损失的应当赔偿。\n  ")]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
    ...
    staticClass: "text-left"
  }, [_vm._v("\n    10.2\n    您不得制作、发布、使用、传播用于窃取"), _c('b', [_vm._v("求真咨询师")]), _vm._v("号码和/或他人个人信息、财产的恶意程序。\n  ")]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
  }, [_vm._v("\n    10.3\n    维护软件安全与正常使用是平台和您的共同责任，平台将按照行业标准合理审慎地采取必要技术措施保护您的终端信息和数据安全，但是您承认和同意平台不能就此提供任何保证。\n  ")]), _vm._v(" "), _c('p', [_c('b', [_vm._v(" 十一、【第三方软件或技术】 ")])]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
    ...
    staticClass: "text-left"
  }, [_vm._v("\n    13.7\n    若本协议有中文、英文等多个语言版本，相应内容不一致的，均以中文版的内容为准。\n  ")]), _vm._v(" "), _c('p', [_c('b', [_vm._v(" 十四、【联系我们】 ")])]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
  }, [_c('b', [_vm._v("\n      14.1\n      当您对我们的产品有相关建议或者有其它相关事宜需要我们协助，或需对发现的违规内容进行投诉、举报，可通过求真咨询师客户端，进入“我的”-“设置”-“联系我们”向我们反馈，我们将尽快审核所涉问题，并在法律法规规定的期限内回复您的请求。\n    ")])])])
}]}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  return _c('div', [_c('div', {
    ...
    staticClass: "text-left"
  }, [_c('b', [_vm._v(" 歡迎您使用「求真咨詢師」軟件及服務！ ")])]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
    ...
    staticClass: "text-left"
  }, [_vm._v("\n    2.1 本軟件是指平臺開發並按照本協議及平臺其他協議、規則之約定授權用戶下載、安裝、使用的"), _c('b', [_vm._v("求真咨詢師")]), _vm._v("軟件。\n  ")]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
    ...
    staticClass: "text-left"
  }, [_vm._v("\n    7.4.1\n    您理解並同意：若您違反法律法規、本協議和/或平臺其他協議、規則的，平臺有權隨時單方根據相應情形采取以下一項或多項措施（具體措施的時間長短由平臺根據您的違法違約情節相應情況確定）：\n    "), _c('br'), _vm._v("\n    （1）對您進行警告。"), _c('br'), _vm._v("\n    （2）限製您使用本軟件和/或本服務部分或全部功能。"), _c('br'), _vm._v("\n    （3）刪除、屏蔽相關內容或斷開鏈接。"), _c('br'), _vm._v("\n    （4）中止、終止您對相應中求真咨詢師賬號的使用（簡稱「封號」）。"), _c('br'), _vm._v("\n    （5）采取其他合理、合法的措施。"), _c('br'), _vm._v("\n    （6）依法追究您的法律責任。 \n  ")]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
  }, [_vm._v("\n    7.4.2\n    如果您違反法律法規、本協議和/或平臺其他協議、規則，平臺對您或您使用的本軟件和/或本服務采取任何行為或措施後，導致您暫時或永久無法使用"), _c('b', [_vm._v("求真咨詢師")]), _vm._v("、無法使用"), _c('b', [_vm._v("求真咨詢師")]), _vm._v("登錄或使用其他產品和/或服務，您應自行承擔相應後果，由此造成您損失的，您應自行承擔。\n  ")]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
    ...
    staticClass: "text-left"
  }, [_vm._v("\n    7.6.1\n    未經授權和許可，用戶不得利用"), _c('b', [_vm._v("求真咨詢師")]), _vm._v("上傳、儲存、共享、傳播含有受到知識產權法律保護的圖像、相片、視頻、軟件或其他數據資料、文件。用戶違反相關知識產權保護法律、規範，侵害第三方合法權益的，均由用戶自行承擔責任，給平臺造成損失的應當賠償。\n  ")]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
    ...
    staticClass: "text-left"
  }, [_vm._v("\n    9.3\n    為了提供更好的服務體驗，我們將陸續完善服務細則，提供豐富的服務內容，具體內容及服務類別以您使用"), _c('b', [_vm._v("求真咨詢師")]), _vm._v("時顯示的頁面為準。關於「"), _c('b', [_vm._v("求真咨詢師")]), _vm._v("付費系列服務」，為您提供如下簡介：\n    "), _c('br'), _vm._v(" "), _c('span', {
    staticClass: "ml-32"
    ...
    staticClass: "text-left"
  }, [_vm._v("\n    11.2\n    您不得製作、發布、使用、傳播用於竊取"), _c('b', [_vm._v("求真咨詢師")]), _vm._v("號碼和/或他人個人信息、財產的惡意程序。\n  ")]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
...
var _cn_agreement = __webpack_require__(1578);

var _cn_agreement2 = _interopRequireDefault(_cn_agreement);

var _tw_agreement = __webpack_require__(1579);
...
var _ios_master_user_agreement = __webpack_require__(714);

var _ios_master_user_agreement2 = _interopRequireDefault(_ios_master_user_agreement);
...
new _vue2.default({
  ...
  template: '<App/>',
  components: { App: _ios_master_user_agreement2.default }
});
