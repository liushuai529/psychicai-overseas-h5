...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  return _c('div', [_c('div', {
    ...
    staticClass: "text-left"
  }, [_c('b', [_vm._v(" 欢迎您使用“命理求真”软件及服务！ ")])]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
    ...
    staticClass: "text-left"
  }, [_vm._v("\n    2.1\n    本软件是指平台开发并按照本协议及平台其他协议、规则之约定授权用户下载、安装、使用的"), _c('b', [_vm._v("命理求真")]), _vm._v("软件。\n  ")]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
    ...
    staticClass: "text-left"
  }, [_vm._v("\n    7.4.1\n    您理解并同意：若您违反法律法规、本协议和/或平台其他协议、规则的，平台有权随时单方根据相应情形采取以下一项或多项措施（具体措施的时间长短由平台根据您的违法违约情节相应情况确定）："), _c('br'), _vm._v("\n    （1）对您进行警告。"), _c('br'), _vm._v("\n    （2）限制您使用本软件和/或本服务部分或全部功能。"), _c('br'), _vm._v("\n    （3）删除、屏蔽相关内容或断开链接。"), _c('br'), _vm._v("\n    （4）中止、终止您对相应中"), _c('b', [_vm._v("命理求真")]), _vm._v("账号的使用（简称“封号”）。"), _c('br'), _vm._v("\n    （5）采取其他合理、合法的措施。"), _c('br'), _vm._v("\n    （6）依法追究您的法律责任。\n  ")]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
  }, [_vm._v("\n    7.4.2\n    如果您违反法律法规、本协议和/或平台其他协议、规则，平台对您或您使用的本软件和/或本服务采取任何行为或措施后，导致您暂时或永久无法使用"), _c('b', [_vm._v("命理求真")]), _vm._v("、无法使用"), _c('b', [_vm._v("命理求真")]), _vm._v("登录或使用其他产品和/或服务，您应自行承担相应后果，由此造成您损失的，您应自行承担。\n  ")]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
    ...
    staticClass: "text-left"
  }, [_vm._v("\n    7.6.1\n    未经授权和许可，用户不得利用"), _c('b', [_vm._v("命理求真")]), _vm._v("上传、储存、共享、传播含有受到知识产权法律保护的图像、相片、视频、软件或其他数据资料、文件。用户违反相关知识产权保护法律、规范，侵害第三方合法权益的，均由用户自行承担责任，给平台造成损失的应当赔偿。\n  ")]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
    ...
    staticClass: "text-left"
  }, [_vm._v("\n    10.2\n    您不得制作、发布、使用、传播用于窃取"), _c('b', [_vm._v("命理求真")]), _vm._v("号码和/或他人个人信息、财产的恶意程序。\n  ")]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
...
var _cn_agreement = __webpack_require__(1609);

var _cn_agreement2 = _interopRequireDefault(_cn_agreement);

var _tw_agreement = __webpack_require__(1610);
...
var _master_user_agreement = __webpack_require__(724);

var _master_user_agreement2 = _interopRequireDefault(_master_user_agreement);
 ...
 * @LastEditors: wujiang
 * @LastEditTime: 2024-02-27 10:24:30
 * @Description: 咨询师端
 */
...
new _vue2.default({
  ...
  template: '<App/>',
  components: { App: _master_user_agreement2.default }
});
