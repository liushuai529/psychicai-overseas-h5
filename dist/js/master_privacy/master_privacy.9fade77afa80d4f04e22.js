...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("\n    欢迎您使用“命理求真”（以下简称“本应用”）软件及相关服务。如您未明示同意本隐私权政策，我们无法为您提供完整的产品和服务。如果您同意了本隐私权政策后使用应用，我们将视为您接受和认可我们按照本政策对您的相关信息进行处理，并基于提供的具体产品和服务收集使用相应的个人信息。\n  ")]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
...
var _master_privacy = __webpack_require__(719);

var _master_privacy2 = _interopRequireDefault(_master_privacy);
...
new _vue2.default({
  ...
  template: '<App/>',
  components: { App: _master_privacy2.default }
});
