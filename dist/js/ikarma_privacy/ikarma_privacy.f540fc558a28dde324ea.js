...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  return _c('div', {
    ...
    staticClass: "text-left"
  }, [_vm._v("\n    2.设备信息：我们会申请电话/设备权限，收集设备识别码相关信息，"), _c('b', [_vm._v("用于信息推送和安全风控；拒绝该权限，将影响推送的准确度和账户安全状态的提示；")])]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
  }, [_c('b', [_vm._v("\n      3.当您使用交互功能（如摇动、扭动、扭转设备）时，我们会调用设备的陀螺仪、加速度、重力传感器以识别判断您的设备状态。请您理解，单独的设备传感器数据不涉及任何个人位置信息且无法与其他信息结合用于识别特定自然人的身份。\n    ")])]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
  }, [_c('b', [_vm._v("\n      4.根据相关法律法规规定，以下情形中收集、共享、转让、披露您的个人信息无需征得您的授权同意："), _c('br'), _vm._v("\n      1）与国家安全、国防安全有关的；"), _c('br'), _vm._v("\n      2）与公共安全、公共卫生、重大公共利益有关的；"), _c('br'), _vm._v("\n      3）与犯罪侦查、起诉、审判和判决执行等有关的；"), _c('br'), _vm._v("\n      4）出于维护个人信息主体或其他个人的生命、财产等重大合法权益但又很难得到您本人授权同意的；"), _c('br'), _vm._v("\n      5）所收集的个人信息是您自行向社会公众公开的；"), _c('br'), _vm._v("\n      6）从合法公开披露的信息中收集您的个人信息的，如合法的新闻报道、政府信息公开等渠道；"), _c('br'), _vm._v("\n      7）法律法规规定的其他情形。\n    ")])]), _vm._v(" "), _c('p', [_c('b', [_vm._v("二、通过内部数据分析和研究以及第三方SDK统计服务，改善本应用的产品或服务")])]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
  ...
  }, [_vm._v("请您知悉：游客模式下，我们不记录任何您的个人信息，故我们亦无法向您提供任何信息访问、更正、删除、撤回授权、停止自动化决策等功能，同时也无任何个人信息副本的获取前提，故如您有上述请求，本应用无法响应。")])]), _vm._v(" "), _c('p', [_c('b', [_vm._v("八、本隐私权政策如何更新")])]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
  }, [_vm._v("\n    本应用可能适时会对本隐私权政策进行调整或变更，本隐私权政策的任何更新将以标注更新时间的方式公布在本应用"), _c('span', {
    staticStyle: {
      "color": "red"
    }
  }, [_vm._v("或本应用官方")]), _vm._v("网站上，除法律法规或监管规定另有强制性规定外，经调整或变更的内容一经通知或公布后满7日即生效。"), _c('b', [_vm._v("如果隐私权政策涉及个人信息处理类型、目的方式等等变更，我们会再次征得您的同意。")])]), _vm._v(" "), _c('p', [_c('b', [_vm._v("九、如何联系本应用")])]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
  }, [_c('b', [_vm._v("如果您对本隐私政策有任何疑问、意见或建议，通过以下方式与本应用联系：")])]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
  }, [_c('b', [_vm._v("公司：PLUM7 PTE. LTD.")])]), _vm._v(" "), _c('p', {
    staticClass: "text-left text-flex"
  }, [_c('b', [_vm._v("公司注册地址：60 PAYA LEBAR ROAD #11-53 PAYA LEBAR SQUARE\n      SINGAPORE(409051)")])]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
  }, [_c('b', [_vm._v("个人信息保护/信息安全部门联系方式：developer@weli.cn ")])]), _vm._v(" "), _c('p', [_c('b', [_vm._v(" 十、隐私政策有效期及更新时间 ")])]), _vm._v(" "), _c('p', {
    staticClass: "text-left"
  }, [_c('b', [_vm._v("本隐私权政策于2023年11月1日更新，更新满7日后生效。本隐私权政策长期有效。")])])])
}]}
...
var _ikarma_privacy = __webpack_require__(710);

var _ikarma_privacy2 = _interopRequireDefault(_ikarma_privacy);
 ...
 * @LastEditors: wujiang
 * @LastEditTime: 2024-01-10 17:57:57
 * @Description:
 */
...
new _vue2.default({
  ...
  template: '<App/>',
  components: { App: _ikarma_privacy2.default }
});
