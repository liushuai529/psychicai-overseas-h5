...
exports.default = {
  ...
  data: function data() {
    return {
      order_id: _utils2.default.getQueryString('order_id') || 0,
      status: ''
    };
  },
  ...
  methods: {
    ...
    checkResult: async function checkResult() {
      _mintUi.Indicator.open(this.$t('pay-check'));
      var data = {
...
var _pay_result = __webpack_require__(725);
...
var _cn = __webpack_require__(696);

var _cn2 = _interopRequireDefault(_cn);

var _tw = __webpack_require__(697);
...
new _vue2.default({
  ...
  i18n: i18n,
  template: '<App/>',
  components: { App: _pay_result2.default }
});
