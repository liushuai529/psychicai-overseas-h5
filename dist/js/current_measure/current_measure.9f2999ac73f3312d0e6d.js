...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "list"
  }, _vm._l((_vm.measure_list), function(item, k) {
    return _c('div', {
      key: 'measure' + k,
      class: ['item', ("item-" + (k + 1))],
      on: {
        "click": function($event) {
          return _vm.jumpMeasure(item)
        }
      }
    }, [_c('div', {
      staticClass: "title"
...
var allMeasure = function allMeasure() {
  return [{
    id: 1,
    name: '瞬时卦',
  ...
  // },
  {
    ...
    id: 5,
    name: '缘分深深',
    url: 'mlxz://intimacy/calculate'
  }, {
    id: 6,
    name: '塔罗问问',
    url: 'mlxz://tarot/gptchat'
  }];
}; //
//
//
...
exports.default = {
  ...
  methods: {
    jumpMeasure: function jumpMeasure(item) {
...
var _current_measure = __webpack_require__(708);

var _current_measure2 = _interopRequireDefault(_current_measure);
...
new _vue2.default({
  ...
  template: '<App/>',
  components: { App: _current_measure2.default }
});
