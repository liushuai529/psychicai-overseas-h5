...
module.exports = "data:image/png;base64,"
...
module.exports = __webpack_require__.p + "img/h5_img_dingdantittle_fan.ec54f47.png";
...
module.exports = __webpack_require__.p + "img/quesheng_no_nothinh.1051142.png";
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    directives: [{
      ...
      value: (function () { return _vm.loadMore(); }),
      expression: "() => loadMore()"
    }],
    class: ['container'],
    attrs: {
  ...
  }, [_vm._v(_vm._s(_vm.$t('tips-2')) + " ")])])]), _vm._v(" "), _c('div', {
    staticClass: "content"
  }, [_c('div', {
    staticClass: "tab-list hidden"
  }, _vm._l((_vm.status_options), function(tab, k) {
    return _c('div', {
      key: 'tab' + k,
      class: {
        item: true,
        'active-tab': _vm.active_tab === tab.v ? true : false,
      },
      on: {
        "click": function($event) {
          _vm.active_tab = tab.v
        }
      }
    }, [_vm._v("\n          " + _vm._s(tab.k) + "\n        ")])
  }), 0), _vm._v(" "), (!_vm.list.length && _vm.is_empty) ? _c('div', {
    staticClass: "empty-list"
  }, [_c('img', {
    staticClass: "nothing-icon",
    attrs: {
    ...
    staticClass: "ad-list"
  }, _vm._l((_vm.ad_list), function(it, k) {
    return _c('img', {
      key: 'ad' + k,
      staticClass: "it",
      attrs: {
    ...
    return _c('div', {
      ...
      class: {
        item: true,
        'two-bg': item.product_key === 'h5_marriage' &&
          !item.can_write &&
          item.status == 'PAYED',
        'write-bg': item.can_write && item.status == 'PAYED',
        'one-bg': item.product_key !== 'h5_marriage' &&
          !item.can_write &&
          item.status == 'PAYED',
        'bg-2-nopay': item.status !== 'PAYED' &&
          item.product_key === 'h5_marriage' &&
          !['h5_combo3', 'h5_combo2', 'h5_combo2_attach'].includes(
            item.product_key
          ),
        'bg-3-nopay': item.status !== 'PAYED' &&
          item.product_key !== 'h5_marriage' && ['h5_combo3'].includes(item.product_key),
        'bg-4-nopay': item.status !== 'PAYED' &&
          item.product_key !== 'h5_marriage' && ['h5_combo2', 'h5_combo2_attach'].includes(item.product_key),
        'bg-1-nopay': item.status !== 'PAYED' &&
          item.product_key !== 'h5_marriage' &&
          !['h5_combo3', 'h5_combo2', 'h5_combo2_attach'].includes(
            item.product_key
          ),
      ...
      attrs: {
        "src": _vm.icon_arr[item.product_key],
        "alt": ""
      }
    }), _vm._v(" "), _c('div', {
      staticClass: "title"
    }, [_vm._v("\n                " + _vm._s(_vm.getTitle(item)) + "\n                "), _c('span', {
      class: ("btn-" + (item.status) + " btn-common " + (_vm.getStyleTag(
                    item
                  )))
    }, [_vm._v("\n                  " + _vm._s(_vm.getTagName(item)) + "\n                ")])])]), _vm._v(" "), _c('div', {
      staticClass: "right"
    }, [_vm._v(_vm._s(_vm.$t('tips-4')) + _vm._s(item.id))])]), _vm._v(" "), _c('div', {
      class: {
        info: !item.can_write,
        'two-info': item.product_key === 'h5_marriage' &&
          !item.can_write &&
          item.status === 'PAYED',
        'one-info': item.product_key !== 'h5_marriage' && item.status === 'PAYED',
        'no-pay-1': item.status !== 'PAYED' &&
          item.product_key !== 'h5_marriage' &&
          !['h5_combo3', 'h5_combo2', 'h5_combo2_attach'].includes(
            item.product_key
          ),
        'no-pay-2': item.status !== 'PAYED' &&
          (item.product_key === 'h5_marriage' || ['h5_combo3', 'h5_combo2', 'h5_combo2_attach'].includes(
            item.product_key
          )),
        'ml-24': item.status !== 'PAYED' &&
          (item.product_key === 'h5_marriage' || ['h5_combo3', 'h5_combo2', 'h5_combo2_attach'].includes(
            item.product_key
          )),
      }
      ...
      staticClass: "left"
    }, [(item.ext.name) ? _c('div', {
      staticClass: "one"
    }, [_c('div', {
      staticClass: "name"
    }, [_c('span', [_vm._v(_vm._s(_vm._f("filterName")(item.ext.name)))]), _vm._v(" "), _c('span', {
      class: {
        birth: true,
        'hidden-one': item.status !== 'PAYED',
      }
    }, [_vm._v(_vm._s(_vm.formateTime(
      item.ext.is_gongli,
      item.ext.birth_year,
      item.ext.birth_month,
      item.ext.birth_date,
      item.ext.birth_hour
    )))]), _vm._v(" "), (item.ext.sex) ? _c('img', {
      staticClass: "sex",
      attrs: {
        "src": ['1', 'male'].includes(item.ext.sex) ?
          _vm.male_icon :
          _vm.female_icon,
        "alt": ""
      }
      ...
      staticClass: "name"
    }, [_c('span', [_vm._v(_vm._s(_vm._f("filterName")(item.ext.male_name)))]), _vm._v(" "), _c('span', {
      class: {
        birth: true,
        'hidden-one': item.status !== 'PAYED',
      }
      ...
      staticClass: "name mt-28"
    }, [_c('span', [_vm._v(_vm._s(_vm._f("filterName")(item.ext.female_name)))]), _vm._v(" "), _c('span', {
      class: {
        birth: true,
        'hidden-one': item.status !== 'PAYED',
      }
    ...
    }, _vm._l((item.combine_product_names), function(i, index) {
      return _c('div', {
        key: index,
        staticClass: "one",
        style: ({
          'margin-bottom': index !== item.combine_product_names.length - 1 ?
            '.24rem' :
            '',
        })
      }, [_vm._v("\n                  " + _vm._s(i) + "\n                ")])
    }), 0), _vm._v(" "), _c('div', {
      staticClass: "right-btn status-other no-pay-btn3",
      style: ({
      ...
      on: {
        "click": function($event) {
          return _vm.handleJump(item)
        }
      }
    }, [_c('div', {
      staticClass: "status-text status-btn"
    }, [_vm._v("重新测算")])])]) : _c('div', {
      staticClass: "no-user"
    }, [_c('div', {
      ...
      staticClass: "one"
    }, [_vm._v(_vm._s(_vm.$t('tips-5')))])]), _vm._v(" "), _c('div', {
      ...
      staticClass: "text"
    }, [_vm._v(_vm._s(_vm.$t('tips-14')))])])])]), _vm._v(" "), (!item.can_write && item.product_key !== 'h5_combo2_attach') ? _c('div', {
      ...
      class: [
        ...
        '' :
        ' visible-hidden' ]
    }, [_c('span', [_vm._v(_vm._s(_vm.$t('tips-7')) + _vm._s(item.transfer_code || '-'))]), _vm._v(" "), _c('span', {
      staticClass: "copy",
      on: {
        "click": function($event) {
          return _vm.copyCode(item.transfer_code)
        }
      }
    }, [_vm._v(_vm._s(_vm.$t('tips-8')))])]), _vm._v(" "), _c('div', {
      class: [
        'right-btn',
        ("" + (_vm.getStatusStyle(item))),
        _vm.getAbsoluteStyle(item) ],
      on: {
        "click": function($event) {
          return _vm.handleJump(item)
        }
      ...
      staticClass: "status-text status-btn"
    }, [_vm._v("\n                " + _vm._s(_vm.statusShow(item)) + "\n              ")])])]) : _vm._e()])
  }), 0)])]), _vm._v(" "), (_vm.code_modal) ? _c('CodePop', {
    attrs: {
      "m_id": "20004"
    },
    on: {
...
var _directive = __webpack_require__(829);
...
/*
 * @Author: wujiang@weli.cn
 * @Date: 2024-04-22 10:43:15
 * @LastEditors: wujiang
 * @LastEditTime: 2024-05-29 11:19:26
 * @Description:
 */
exports.default = {
  'page-title': '历史订单',
  'tips-1': '复制订单识别码，打开命理寻真，您可以在命理寻真中查看您的报告。',
  'tips-2': '立即下载',
  'tips-3': '咦？您还没有测算择吉报告',
  'tips-4': '订单编号：',
  'tips-5': '信息未添加',
...
exports.default = {
  'page-title': '歷史訂單',
  'tips-1': '復製訂單識別碼，打開命理尋真，您可以在命理尋真中查看您的報告。',
  'tips-2': '立即下載',
  'tips-3': '咦？您還沒有測算擇吉報告',
  'tips-4': '訂單編號：',
  'tips-5': '信息未添加',
...
var _outer_order = __webpack_require__(1586);

var _outer_order2 = _interopRequireDefault(_outer_order);
...
exports.default = {
  name: 'HistoryOrder',
  components: {
    outerOrder: _outer_order2.default
  },
  data: function data() {
    return {};
  },
...
var _3 = __webpack_require__(354);
...
var _h5_img_dingdantittle_fan = __webpack_require__(1196);

var _h5_img_dingdantittle_fan2 = _interopRequireDefault(_h5_img_dingdantittle_fan);
...
var all_status_enums = function all_status_enums() {
...
exports.default = {
  data: function data() {
    return {
      cn_title: 'https://psychicai-static.psychicai.pro/imgs/24044c3bf50f5d8d4ac8b858aa684e0b1d75.png',
      tw_title: _h5_img_dingdantittle_fan2.default,
      status_options: [{
        k: '全部订单',
        v: 1
      }, {
      ...
      jump_loading: false,
      is_android: false,
      male_icon: 'https://psychicai-static.psychicai.pro/imgs/24042cba8d2e03aa4538802aa57b2de12259.png',
      female_icon: 'https://psychicai-static.psychicai.pro/imgs/2404e3255ac4cfa947bf997cd92d39d15a9f.png',

      code_modal: false,
      icon_arr: _enum.getHistoryOrderImg
    };
  },
  ...
  created: function created() {
    ...
    setInterval(function () {
      var is_reload = localStorage.getItem('mlxz_reload_page_history');
      if (is_reload) {
        _this.query.page = 1;
        _this.list = [];
        _this.getData();
  ...
  mounted: function mounted() {
    _utils2.default.firebaseLogEvent('10002', '-10001', 'page_view_history', 'page_view', {
      args_name: 'page_view_history',
      channel: _utils2.default.getFBChannel()
    });

    this.is_android = _utils2.default.isAndroid();
    this.getData();
  },

  watch: {
    active_tab: function active_tab(val) {
      this.query.page = 1;
      this.list = [];
      this.getData();
    }
  ...
  methods: {
    ...
    getData: async function getData() {
      ...
      var _ref = await (0, _api.getHistoryOrderAPI)(this.query),
          status = _ref.status,
          data = _ref.data;
      ...
      this.list = this.query.page === 1 ? data.data_list : [].concat(_toConsumableArray(this.list), _toConsumableArray(data.data_list));
     ...
     * @return {*}
     */
    formateTime: function formateTime(is_gongli, year, month, date, hour) {
      if (is_gongli == '1') {
        return year + '\u5E74' + month + '\u6708' + date + '\u65E5' + (hour === '-1' ? '\u672A\u77E5' + this.$t('tips-11') + '\u8FB0' : hour + this.$t('tips-11'));
      } else {
        return year + '\u5E74' + _utils2.default.nongliMonthEnum()[+month - 1] + _utils2.default.nongliDayEnum()[+date - 1] + (hour === '-1' ? '\u672A\u77E5' + this.$t('tips-11') + '\u8FB0' : _utils2.default.nongliHourEnum()[+hour / 2]);
      }
    },
    ...
    openApp: async function openApp() {
      _utils2.default.firebaseLogEvent('10002', '-10002', 'click_history_download', 'click', {
     ...
     * @return {*}
     */
    handleJump: async function handleJump(item) {
      var _this2 = this;
      ...
      //   return;
      // }
      var url = _enum.path_enums[item.product_key];
      if (item.status === 'PAYED') {
        ...
        _mintUi.Indicator.open(this.$t('tips-17'));
        ...
        var status = item.status,
            ...
            ext = item.ext,
            trade_pay_type = item.trade_pay_type,
            trade_target_org = item.trade_target_org,
            combine_product_ids = item.combine_product_ids;

        if (combine_product_ids && combine_product_ids.length) {
          var length_ = combine_product_ids.length;
          var _params = {
          ...
          if (product_key === 'h5_combo2_attach') {
            var same_product = this.productList.find(function (item) {
              return item.product_id === combine_product_ids[0];
            });
            var back_url = _enum.path_enums[same_product.product_key];
            _params.extra_ce_suan = ext;
            _params.callback_url = location.origin + '/' + _utils2.default.getFBChannel() + '/' + back_url + '.html#/result?path=' + _enum.path_enums[same_product.product_key] + '&report_price=' + payment + '&repay=3';

            var e_name = same_product.product_key === 'h5_emotion2024' ? 'click_history_2024lovelymarriage_repay' : 'click_history_marriage2024lovely_repay';
            var e_id = same_product.product_key === 'h5_emotion2024' ? '-10030' : '-10031';
            _utils2.default.firebaseLogEvent('10002', e_id, e_name, 'click', {
              args_name: e_name,
              channel: _utils2.default.getFBChannel()
            });
          } else {
            _utils2.default.firebaseLogEvent('10002', length_ === 2 ? '-10010' : '-10011', length_ === 2 ? 'click_history_report2_repay' : 'click_history_report3_repay', 'click', {
              args_name: length_ === 2 ? 'click_history_report2_repay' : 'click_history_report3_repay',
              channel: _utils2.default.getFBChannel()
            });
            _params.callback_url = location.origin + ('/' + _utils2.default.getFBChannel() + '/') + 'index.html' + '?pay_index=' + length_ + '&report_price=' + payment + '&repay=1';
          }

          var _res = await (0, _api.payOrderAPI)(_params);
        ...
        _utils2.default.firebaseLogEvent('10002', event_enums[product_key].c_id, event_enums[product_key].c_name, 'click', {
        ...
        params.callback_url = location.origin + '/' + _utils2.default.getFBChannel() + '/' + url + '.html#/result?path=' + _enum.path_enums[product_key] + '&report_price=' + payment + '&repay=1';
        var res = await (0, _api.payOrderAPI)(params);
        ...
        // 跳转支付页
        if (item.ext.name) {
          location.href = url + '.html#/' + this.singleParams(item.ext) + '&order_id=' + item.id;
        } else {
          location.href = url + '.html#/' + this.coupleParams(item.ext) + '&order_id=' + item.id;
        }
      }
    },
     ...
     * @return {*}
     */
    statusShow: function statusShow(it) {
      if (it.status === 'PAYED') {
     ...
     * @return {*}
     */
    singleParams: function singleParams(item) {
      var name = item.name,
          sex = item.sex,
          is_gongli = item.is_gongli,
          birth_year = item.birth_year,
          birth_month = item.birth_month,
          birth_hour = item.birth_hour,
     ...
     * @return {*}
     */
    coupleParams: function coupleParams(item) {
      var male_name = item.male_name,
          male_is_gongli = item.male_is_gongli,
          male_birth_year = item.male_birth_year,
          male_birth_month = item.male_birth_month,
          male_birth_hour = item.male_birth_hour,
          male_birth_date = item.male_birth_date,
          female_name = item.female_name,
          female_is_gongli = item.female_is_gongli,
          female_birth_year = item.female_birth_year,
          female_birth_month = item.female_birth_month,
          female_birth_hour = item.female_birth_hour,
          female_birth_date = item.female_birth_date;
     ...
     * @return {*}
     */
    formateName: function formateName(str, start, end) {
    ...
    copyCode: function copyCode(code) {
      _utils2.default.copyText('mlxz-' + code);
      (0, _mintUi.Toast)('复制成功');
      this.code_modal = true;
    },
    backPage: function backPage() {
      history.back();
    },
    getTagName: function getTagName(item) {
      var status = item.status,
          ext = item.ext;

      if (status === 'PAYED') {
        return ext ? !ext.name || !ext.male_name ? this.$t('tips-15') : '' : '';
      } else {
        return '待支付';
      }
    },
    getStyleTag: function getStyleTag(item) {
      var status = item.status,
          ext = item.ext;
    ...
    getStatusStyle: function getStatusStyle(item) {
      var status = item.status,
          ext = item.ext;
    ...
    getAbsoluteStyle: function getAbsoluteStyle(item) {
      var status = item.status,
          ext = item.ext,
          product_key = item.product_key;

      if (status !== 'PAYED') {
        if (product_key !== 'h5_marriage' && product_key !== 'h5_combo2_attach') {
          return 'no-pay-btn1';
        } else {
          return 'no-pay-btn2';
        }
...
var _history_order = __webpack_require__(715);
...
var _cn = __webpack_require__(688);

var _cn2 = _interopRequireDefault(_cn);

var _tw = __webpack_require__(689);
...
new _vue2.default({
  ...
  i18n: i18n,
  template: '<App/>',
  components: { App: _history_order2.default }
});
