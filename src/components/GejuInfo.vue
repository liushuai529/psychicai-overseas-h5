  ...
  <div :id="product_key !== 'h5_emotion2024' ? 'mode_middle' : ''" class="main">
    ...
    <div v-for="(item, idx) in renderData" :key="idx">
      <div class="nav_item">
        ...
        <div class="nav_desc" v-html="item.all"></div>
      </div>
      <div class="nav_item">
        ...
        <div class="nav_desc" v-html="item.love"></div>
      </div>
      <div class="nav_item">
        <div class="nav_header" v-if="product_key === 'h5_emotion2024'">
          <img src="../assets/img/geju/left_heart.webp" alt="" />
        ...
        <div class="nav_desc" v-html="item.cause"></div>
      </div>
      <div
        class="nav_item"
        v-if="product_key !== 'h5_emotion2024' && idx !== renderData.length - 1"
      >
...
export default {
  ...
  computed: {
    ...
    info() {
      console.log(this.$store.state.male_str);
