<template>
    <div class="order-item">
        <img class="title" src="./../../../assets/img/gossip/qiguashijian.png" />
        <div class="content">
            <div class="item">
...
<script>
    ...
    export default {
        ...
        mounted () {
            ...
            this.gongli_time = year + '年' + gongli_month + '月' + gongli_date + '日' + gongli_hour + '时' + gongli_minute + '分';

            // 计算农历时间
            let nongli_year_info = this.nongli_str.huangli.huangli_another_info.split(' ');
            let nongli_month_info = this.nongli_str.nongli.date;
            this.nongli_time = nongli_year_info[0] + nongli_month_info + this.transHour(hour);
