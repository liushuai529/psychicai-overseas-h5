    ...
    <div class="user-info" :style="{ backgroundImage: bgc }">
      ...
      <div class="content">
        <p class="name">
          ...
          }}<span class="sex">性别：{{ userInfo.sex }}</span>
        </p>
        <p class="birthday">
      ...
      <img
        ...
        src="./../../../assets/img/mlxz/lucky_year_report/detail/content_title_1.png"
        alt=""
      />
      <div
        v-if="dayun"
...
import content_bg_1 from './../../../assets/img/mlxz/lucky_year_report/detail/content_bg_1.png';
...
export default {
  ...
  methods: {
    decodeUnicode(str) {
      str = str.replace(/\\/g, '%');
      return unescape(str).length > 4
        ? unescape(str).substring(0, 4) + '...'
        : unescape(str);
    },
    copyOrder() {
