<template>
  <div class="result" :class="['result']">
    <ChatCard v-if="is_first" :transfer_code="transfer_code" sub_type="zhuan_chang"/>
    ...
    <div class="content-container">
      <div class="item" v-if="message_show1">
        <img src="../../../assets/img/emotion_voice/lianmai_img_chat_avatar.webp" />
        <div class="message">
          {{ `您好，${username}，${is_cn ? '我是本次服务您的情感导师！' : '我是本次服務您的情感導師！'}` }}
        </div>
      </div>
...
import cn_img_chat_top_laoshi from '../../../assets/img/emotion_voice/cn/lianmai_img_chat_top_laoshi_cn.webp';
import tw_img_chat_top_laoshi from '../../../assets/img/emotion_voice/tw/lianmai_img_chat_top_laoshi_tw.webp';


import img_chat_dibu_android_cn from '../../../assets/img/emotion_voice/cn/img_chat_dibu_android_cn.webp';
import img_chat_dibu_android_tw from '../../../assets/img/emotion_voice/tw/img_chat_dibu_android_tw.webp';

import img_popovers_logo_android_cn from '../../../assets/img/emotion_voice/cn/img_popovers_logo_android_cn.webp';

import img_popovers_logo_android_tw from '../../../assets/img/emotion_voice/tw/img_popovers_logo_android_tw.webp';
...
export default {
  ...
  computed: {
    ...
    get_card_title() {
      ...
      return utils.getLanguage() === 'zh-CN'? `您的【感情专场咨询】真人1v1咨询订单已生成，您可前往【${app_name}】App中进行实时咨询`: `您的【感情專場咨詢】真人1v1咨詢訂單已生成，您可前往【${app_name}】App中進行實時咨詢`
    }
  },
  watch: {
    is_first(val) {
