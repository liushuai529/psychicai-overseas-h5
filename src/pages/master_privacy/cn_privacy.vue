<template>
  <div>
    ...
    <p class="text-left">
      3.设备信息：我们会申请电话/设备权限，收集设备识别码相关信息，<b
        >用于信息推送和安全风控；拒绝该权限，将影响推送的准确度和账户安全状态的提示。</b
      >
    </p>
    <p class="text-left">
      4.存储权限：当您使用聊天、阅读等功能时，我们需要申请存储权限，以通过写入本地缓存的方式存储应用的相关数据，<b
        >以保证您的使用记录等信息不会丢失，并降低流量消耗；</b
      >
    </p>
    <p class="text-left">
      <b
        >5.读取本地相册及相机权限。当您设置、更换用户头像、添加照片需使用“拍照”功能时，我们会请求您授权相机或本地相册权限。如果您同时拒绝上述两个权限，将无法使用此功能。</b
      >
    </p>
    <p class="text-left">
      6.为保障您及时接收相关消息，我们会请求您授权<b>通知权限</b>。如您拒绝提供，仅会使您无法使用该功能，但不影响您正常使用本软件的其他功能。
    </p>
    <p class="text-left">
      7.读取日历权限。当您需要展示系统日历的日程信息时，我们会请求您日历权限。如果您拒绝授权提供，将无法使用此功能。
    </p>
    <p class="text-left">
      8.为了正常接收客户预约、咨询等重要提醒，您可以在手机系统设置中开启命理求真关联启动，保证APP相关进程运行来推送提醒信息。<b>
        同时，由于本应用SDK技术由与我们合作的第三方机构提供，为保障消息触达的及时性，在您使用消息推送服务时，您可以授权我们进行链路调节，相互促活被关闭的SDK推送进程，从而保障推送消息的有效触达。上述内容您可详阅本政策第四条。
      </b>
    </p>

    <p class="text-left">
      9.如果您在本应用发生交易行为，则相关支付功能由我们合作的第三方机构向您提供，第三方机构可能需要收集您的姓名、银行卡类型、银行卡账号、银行卡有效期、银行卡绑定的手机号码。如果您拒绝提供支付必须信息，则您无法完成交易，从而无法使用对应的服务，但不会影响其他功能的正常使用。<b
        >我们仅会从第三方机构处获取您的交易成功的结果验证信息并向您提供服务。在您注销账号时，本应用将停止使用并删除上述信息。</b
      >
    </p>
    <p>
      <b>
        <span class="ml-32"> 10.自启动和关联启动说明 </span>
        <br />
        <span class="ml-32">
    ...
    <p class="text-left">
      <b
        >2.更正您的个人信息，当您发现本应用处理的关于您的个人信息有错误时，您有权要求本应用做出更正。您还可以在登录后，点击“我的”-“用户头像”进入个人中心，在该页面您可修改您的头像、昵称，在“您的信息”条目中修改您的真实姓名、性别等信息。</b
      >
    </p>
    <p class="text-left">
      <b
    ...
    <p class="text-left">
      <b>个人信息保护/信息安全部门联系方式：copilot7server@wekoi.cn</b>
    </p>
    <p>
      <b> 十一、隐私政策有效期及更新时间 </b>
    </p>
    <p class="text-left">
      <b
        >本隐私权政策于2024年2月15日更新，更新满7日后生效。本隐私权政策长期有效。</b
      >
    </p>
  </div>
</template>
