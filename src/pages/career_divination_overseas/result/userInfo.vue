  ...
  <div class="user-info">
    <div class="top">
      <div
        ...
        :style="{
          backgroundImage:
            'url(' + (language === 'zh-CN' ? title_nan_bg : tw_bg) + ')',
        }"
      ></div>
      <div
        class="title"
        ...
        :style="{
          backgroundImage:
            'url(' + (language === 'zh-CN' ? title_nv_bg : tw_bg) + ')',
        }"
      ></div>
      <div class="detail">
        <p class="name">
    ...
    <div class="middle">
      <p>
        <span>
          <span class="subtitle">{{ $t('nongli-label') }}年份：</span>
          <span>{{ data.nl }}</span>
        </span>
        <span class="fl-right">
          <span class="subtitle">{{ $t('taisui-label') }}：</span>
          <span>{{ data.tsm }}</span>
        </span>
      </p>
      <p>
        <span>
          <span class="subtitle">{{ $t('liunian-label') }}：</span>
          <span>{{ data.ny }}</span>
        </span>
        <span class="fl-right">
          <span class="subtitle">{{ $t('taisuifangwei-label') }}：</span>
          <span>{{ data.tsfw }}</span>
        </span>
      </p>
      <p>
        <span>
          <span class="subtitle">{{ $t('ganzhijinian-label') }}：</span>
          <span>{{ data.gz }}</span>
        </span>
        <span class="fl-right">
          <span class="subtitle">{{ $t('suipofangwei-label') }}：</span>
          <span>{{ data.sp }}</span>
        </span>
      </p>
    </div>
    <div class="bottom">
      <p>
        <span class="subtitle">{{ $t('mingfantaisui-label') }}：</span>
        <span>{{ data.mf }}</span>
      </p>
      <p>
        <span class="subtitle">{{ $t('zhaifantaisui-label') }}：</span>
        <span>{{ data.zf }}</span>
      </p>
    </div>
  </div>
...
import tw_bg from '../../../assets/img/tw_mlxz/career/result/ziliao.png';
export default {
  props: ['userInfo', 'data'],
  data() {
    return {
