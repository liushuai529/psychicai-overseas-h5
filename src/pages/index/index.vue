...
export default {
  ...
  created() {
    ...
    this.is_show_combine = ["enjoy03", "enjoy103", "enjoy203","panda03", "ocean03", "enjoy05", "enjoy105", "enjoy205","ocean05"].includes(
      utils.getFBChannel()
    );
...
&pay_modal=1&use_fixed_time=1&discount_pay=1`;
    ...
    logPageView(val) {
      ...
      if (!["enjoy03", "enjoy103", "enjoy203", "panda03", "ocean03", "enjoy05", "enjoy105", "enjoy205","ocean05"].includes(channel)) {
        return;
      }
      if (val === 0) {
