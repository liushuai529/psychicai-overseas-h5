...
const card_info_array = [{
  m_id: '10010', c_id: '-10004', e_name: 'click_pullcards_first', type: 'click'
}, {
  m_id: '10010', c_id: '-10005', e_name: 'click_pullcards_second', type: 'click'
}, {
  m_id: '10010', c_id: '-10006', e_name: 'click_pullcards_third', type: 'click'
}]
export default {
  props: {
    customData: {
    ...
    card_clicked(idx, { target }) {
      ...
      this.card_selection_animation(target.getBoundingClientRect(), targetCardWrapper.getBoundingClientRect(), isLeft, () => {
        ...
        utils.firebaseLogEvent(
          ...
          card_info_array[this.selected_card_num]['type'],
          {
