<template>
  <div>
    ...
    <p class="text-left"><b> 歡迎您使用「命理尋真」軟件及服務！ </b></p>
    <p class="text-left">
      <b>
    ...
    <p class="text-left">
      2.1 本軟件是指平臺開發並按照本協議及平臺其他協議、規則之約定授權用戶下載、安裝、使用的<b>命理尋真</b>軟件。
    </p>
    <p class="text-left">
    ...
    <p class="text-left">
      ...
      （3）刪除、屏蔽相關內容或斷開鏈接。<br />
      （4）中止、終止您對相應中命理尋真賬號的使用（簡稱「封號」）。<br />
      （5）采取其他合理、合法的措施。<br />
      （6）依法追究您的法律責任。 
    </p>
    <p class="text-left">
      7.4.2
      如果您違反法律法規、本協議和/或平臺其他協議、規則，平臺對您或您使用的本軟件和/或本服務采取任何行為或措施後，導致您暫時或永久無法使用<b>命理尋真</b>、無法使用<b>命理尋真</b>登錄或使用其他產品和/或服務，您應自行承擔相應後果，由此造成您損失的，您應自行承擔。
    </p>
    <p class="text-left">
      7.4.3
    ...
    <p class="text-left">
      7.6.1
      未經授權和許可，用戶不得利用<b>命理尋真</b>上傳、儲存、共享、傳播含有受到知識產權法律保護的圖像、相片、視頻、軟件或其他數據資料、文件。用戶違反相關知識產權保護法律、規範，侵害第三方合法權益的，均由用戶自行承擔責任，給平臺造成損失的應當賠償。
    </p>
    <p class="text-left">
      <b>
        7.6.2
    ...
    <p class="text-left">
      9.3
      為了提供更好的服務體驗，我們將陸續完善服務細則，提供豐富的服務內容，具體內容及服務類別以您使用<b>命理尋真</b>時顯示的頁面為準。關於「<b>命理尋真</b>付費系列服務」，為您提供如下簡介：
      <br />
    ...
    <p class="text-left">
      11.2
      您不得製作、發布、使用、傳播用於竊取<b>命理尋真</b>號碼和/或他人個人信息、財產的惡意程序。
    </p>
    <p class="text-left">
      11.3
