...
import index from '../pages/emotion_remarriage/home/index.vue';
import detail from '../pages/emotion_remarriage/detail/index.vue';
import result from '../pages/emotion_remarriage/result/index.vue';
import order from '../pages/emotion_remarriage/order/index.vue';
...
const visitorLoginAPI = async (data, callback) => {
  if (
    ...
    fbq && fbq('init', utils.getFbId()[utils.getFBChannel()], {'external_id': localStorage.getItem('mlxz_outer_visitor_id')|| ''});
  }
